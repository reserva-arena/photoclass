...
import { garantirTokenAcesso, obterOuCriarPasta, moverArquivo, copiarArquivo, excluirArquivo, definirEmailUsuario } from "./drive-upload.js?v=20260727a";
import { DRIVE_CONFIG } from "./drive-config.js?v=20260727a";
