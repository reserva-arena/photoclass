...
import { garantirTokenAcesso, obterOuCriarPasta, moverArquivo, copiarArquivo, excluirArquivo, definirEmailUsuario } from "./drive-upload.js?v=20260727r";
import { aprenderComFoto } from "./aprendizado.js?v=20260727r";
import { DRIVE_CONFIG } from "./drive-config.js?v=20260727r";
