...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260727d";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260727d";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260727d";
