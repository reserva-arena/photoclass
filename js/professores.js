...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260727l";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260727l";
