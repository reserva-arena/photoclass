...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260812b";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260812b";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260812b";
import { aprenderComFoto } from "./aprendizado.js?v=20260812b";
import { garantirTokenAcesso, obterOuCriarPasta, obterPastaRaizDaTurma, obterModeloDaTurma, concederAcessoEditorPasta, excluirPasta, adicionarMembroDriveCompartilhado, definirEmailUsuario } from "./drive-upload.js?v=20260812b";
