...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260812f";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260812f";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260812f";
import { aprenderComFoto } from "./aprendizado.js?v=20260812f";
import { garantirTokenAcesso, obterOuCriarPasta, obterPastaRaizDaTurma, obterModeloDaTurma, concederAcessoEditorPasta, excluirPasta, adicionarMembroDriveCompartilhado, definirEmailUsuario } from "./drive-upload.js?v=20260812f";
