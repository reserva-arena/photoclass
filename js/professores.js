...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260728f";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260728f";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260728f";
import { aprenderComFoto } from "./aprendizado.js?v=20260728f";
