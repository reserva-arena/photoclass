...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260812e";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260812e";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260812e";
import { aprenderComFoto } from "./aprendizado.js?v=20260812e";
import { garantirTokenAcesso, obterOuCriarPasta, obterPastaRaizDaTurma, obterModeloDaTurma, concederAcessoEditorPasta, excluirPasta, adicionarMembroDriveCompartilhado, definirEmailUsuario } from "./drive-upload.js?v=20260812e";
