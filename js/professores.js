...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260727a";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260727a";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260727a";
