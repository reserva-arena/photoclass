...
import { auth, db, firebaseConfig } from "./firebase-config.js?v=20260812a";
...
import { configurarAlternadorVisao, configurarNavProfessores, configurarMenuMobile, estaEmModoAdmin } from "./roles.js?v=20260812a";
import { TURMAS, NOMES_SEGMENTO } from "./turmas.js?v=20260812a";
import { aprenderComFoto } from "./aprendizado.js?v=20260812a";
import { garantirTokenAcesso, obterOuCriarPasta, obterPastaRaizDaTurma, obterModeloDaTurma, concederAcessoEditorPasta, excluirPasta, adicionarMembroDriveCompartilhado, definirEmailUsuario } from "./drive-upload.js?v=20260812a";
