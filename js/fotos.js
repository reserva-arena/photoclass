...
import { mostrarAlertaPendentes } from "./alerta-pendentes.js?v=20260728f";
import { garantirTokenAcesso, obterPastaDestino, enviarArquivo, definirEmailUsuario } from "./drive-upload.js?v=20260728f";
